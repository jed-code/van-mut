...
function Page() {
  ...
  useEffect(() => {
    if (id) {
      // const foundItem = sliderMenuItems.find(
      //   (item) => item.id === parseInt(id, 10)
      // );
      // setMenuItems(foundItem);
    }
  }, [id]);

  return (
    <Layout>
      <PageBanner pageName={"Blog Id"} />
      <section className="news-details-page rel z-1 pt-65 rpt-35 pb-130 rpb-100 bg-danger">
